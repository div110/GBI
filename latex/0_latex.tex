...
Jádro, kernel, je součást většiny operačních systémů zajišťující přístup k~fyzickým prostředkům počítače. Mezi hlavní činnosti patří správa: procesorů, procesů, pamětí a periferií. 
\subsection{Princip}
